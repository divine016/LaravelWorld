...
<div class="flex w-full h-full box-border">
    <main class="h-full w-full m-20 p-10 flex-col  text-center justify-center items-center gap-10 drop-shadow-xl bg-indigo-100">
        <div class="w-full">
            <h1>Create an <span>opportunity</span></h1>
            <div class="flex justify-center items-center">
                ...
                >
                    ...
                    <div class="flex items-start flex-col gap-5 capitalize ">
                        <!-- <img width="100" height="100" src="images/placeholder.png" alt="place holder for image todo" id="profileDislay" style="display: block; border-radius: 50%; text-align: center;" onclick="triggerClick()"> <br>
                        <label for="image">Upload todo image (jpeg, jpg, png)</label> <br>
                        <input type="file" accept="image/png, image/jpg, image/jpeg" name="image" value="uploadImage" onchange="displayImage(this)" id="uploadImage" style="display: none;"> <br><br>
